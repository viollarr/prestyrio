...
header("Content-Disposition: attachment; filename=relatorio_pg_montadores_de_".$arquivo_inicio."_ate_".$arquivo_final.".xls");
		...
		echo "<table border='1' width='100%' cellspacing='1'>
				...
				<tr>
					...
					<td colspan='6' align='center'><b><h3>$texto DO DIA $data_inicio &Aacute; $data_fim</h3></b></td>
				...
				<tr>
				  ...
				  <td align='center' width='100' bgcolor='#F2F2F2'><b>Descri&ccedil;&atilde;o</b></td>
		...
		elseif($prioridade == 4){
			...
			if($prioridade == 0){
				...
				elseif($tipo == 5){
					...
					$texto_condicao = "JJUSTI&Ccedil;A NORMAL";
				...
				elseif($tipo == 7){
					...
					$texto_condicao = "REVIS&Atilde;O NORMAL";
				...
				elseif($tipo == 8){
					...
					$texto_condicao = "T&Eacute;CNICA NORMAL";
				...
				elseif($tipo == 9){
					...
					$texto_condicao = "DESMONTAGEM NORMAL";
			...
			elseif($prioridade == 2){
				...
				if($tipo == 3){
					...
					$texto_condicao = "MONTADA JUR&Iacute;DICO";
				...
				elseif($tipo == 5){
					...
					$texto_condicao = "JJUSTI&Ccedil;A JUR&Iacute;DICO";
				...
				elseif($tipo == 7){
					...
					$texto_condicao = "REVIS&Atilde;O JUR&Iacute;DICO";
				...
				elseif($tipo == 8){
					...
					$texto_condicao = "T&Eacute;CNICA JUR&Iacute;DICO";
				...
				elseif($tipo == 9){
					...
					$texto_condicao = "DESMONTAGEM JUR&Iacute;DICO";
			...
			elseif($prioridade == 4){
				...
				elseif($tipo == 5){
					...
					$texto_condicao = "JJUSTI&Ccedil;A LOJA";
				...
				elseif($tipo == 7){
					...
					$texto_condicao = "REVIS&Atilde;O LOJA";
				...
				elseif($tipo == 8){
					...
					$texto_condicao = "T&Eacute;CNICA LOJA";
				...
				elseif($tipo == 9){
					...
					$texto_condicao = "DESMONTAGEM LOJA";
			...
			if($prioridade == 0){
				...
				if($tipo == 3){
					...
					$texto_condicao = "MONTAGEM NORMAL";
			...
			elseif($prioridade == 2){
				...
				if($tipo == 3){
					...
					$texto_condicao = "MONTAGEM JUR&Iacute;DICO";
...
$texto_condicao = "DESMONTAGEM LOJA";
			...
			echo "<tr>";
				...
				echo "<td align='center' style='font-size:10px; font-family:Verdana, Arial, Helvetica, sans-serif;' bgcolor='#F2F2F2'>$texto_condicao</td>";
	...
	if($not == 2){
		  ...
		  echo "<tr>
		  			...
		  			<td align='right' colspan='5' style='font-size:10px; font-family:Verdana, Arial, Helvetica, sans-serif;' ><strong>TOTAL BRUTO</strong></td>
