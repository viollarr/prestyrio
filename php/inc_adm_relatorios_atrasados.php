...
include"config.php";
	...
	*/
	...
	$sql = mysql_query($select_paginacao); // Executa a query no MySQL com o limite de linhas.
		...
		echo "<td class='texto' width='105'><b>Or&ccedil;amento</b></td>";
		echo "<td class='texto' width='100'><b>Montador</b></td>";
		...
		while ($linha = mysql_fetch_array($sql))
		{
			...
			echo "<td class='texto'><a href='vis_clientes.php?id_clientes=$id_clientes'>$bairro</a></td>";
			if($status == 2){
			####################################### PRE BAIXAS ##################################################
