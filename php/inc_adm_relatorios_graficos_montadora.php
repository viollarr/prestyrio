...
if ((!empty($data_inicio))&&(!empty($data_fim))){
		$select = "SELECT * FROM clientes c, datas d, ordem_montagem o WHERE c.n_montagem = o.n_montagem AND d.n_montagens = o.n_montagem AND (d.data_recebimento >= '$data_inicio' AND d.data_recebimento <= '$data_fim') AND c.ativo='$ativo' ORDER BY o.n_montagem ASC";
