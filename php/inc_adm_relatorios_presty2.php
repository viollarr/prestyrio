		...
		while ($rs = mysql_fetch_array($executa)){
			...
			if($prioridade == 0){
				...
				elseif($tipo == 7){
					...
					$preco_real = number_format(8.10,2,',','');

					$preco_real2 = number_format(8.10,2,',','');

					$preco_real3 = number_format(8.10,2,',','');

					$preco_real4 = number_format(8.10,2,',','');

					$preco_real5 = number_format(8.10,2,',','');

					$preco_real6 = number_format(8.10,2,',','');
