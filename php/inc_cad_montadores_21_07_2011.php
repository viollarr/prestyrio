...
$insert = "INSERT INTO montadores (nome, admissao, demissao, $cadastra_nome_foto rota, nome_conta, ag, conta, banco, cpf, rg, comentario, cep, rua, numero, comp, bairro, cidade, estado, telefone, celular, email, atendimento) VALUES ('".$nome."', '".$ad."', '".$de."', $cadastra_foto '".$rota."', '".$nome_c."', '".$agencia."', '".$conta."', '".$banco."', '".$cpf."', '".$rg."', '".$observacao."', '".$cep."', '".$rua."', '".$numero."', '".$comp."', '".$bairro."', '".$cidade."', '".$estado."', '".$tel."', '".$cel."', '".$email."', '".$atendimento."')";
