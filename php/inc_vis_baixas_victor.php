...
$select = "SELECT c.prioridade, c.tipo, c.nome_cliente, c.orcamento, d.data_saida_montador, d.data_entrega_montador, d.data_final, o.n_montagem, o.comentario, o.status, o.id_montador, o.id_montagem FROM ordem_montagem o, datas d, clientes c WHERE o.id_montagem = '".$_GET['id_montagem']."' AND (c.n_montagem = o.n_montagem AND c.n_montagem = d.n_montagens AND o.n_montagem = d.n_montagens )";
