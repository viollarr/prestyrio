...
if ($x = mysql_fetch_array($y)){
	...
	if(strlen($x["telefone"]) <= 11){
		$telefone = "(21)".$x["telefone"];
	}
	else{
		$telefone = $x["telefone"];	
	}
	
	if(strlen($x["celular"]) <= 11){
		$celular = "(21)".$x["celular"];
	}
	else{
		$celular = $x["celular"];	
	}
...
<form name="form1" method="post" enctype="multipart/form-data" <?php if(($_SESSION['login'] == 'narcizo') || ($_SESSION['login'] == 'andreia') || ($_SESSION['login'] == 'ANDREIA') || ($_SESSION['login'] == 'MIRIAN') || ($_SESSION['login'] == 'mirian') || ($_SESSION['login'] == 'luciana') || ($_SESSION['login'] == 'LUCIANA') || ($_SESSION['login'] == 'SUZI') || ($_SESSION['login'] == 'suzi')){ ?> action="php/alterar_db_montadores.php?id_montadores=<?=$x[id_montadores]?>"> <?php } else{ ?> > <?php } ?>
...
<?php if(($_SESSION['login'] == 'narcizo') || ($_SESSION['login'] == 'andreia') || ($_SESSION['login'] == 'ANDREIA') || ($_SESSION['login'] == 'MIRIAN') || ($_SESSION['login'] == 'mirian') || ($_SESSION['login'] == 'luciana') || ($_SESSION['login'] == 'LUCIANA') || ($_SESSION['login'] == 'SUZI') || ($_SESSION['login'] == 'suzi')){ ?>
		<tr>
 ...
 <?php } ?>
      ...
      <script language="javascript">addCampos('demissao');</script>
    	...
    	<tr>
        	...
        	<td width="354" align="left" colspan="3"><input name="dataNascimento" type="text" id="dataNascimento" value="<?=$x['data_nascimento']?>" class="data datepicker" size="10"  tabindex="10" /></td>
		...
		<tr>
			...
			<td align="left"><input type="text" name="res" id="res" value="<?=$telefone?>" size="12" class="telefone" tabindex="11" /></td>
            <script language="javascript">addCampos('res');</script>
			<td align="left">Celular: </td>
			<td align="left"><input type="text" name="cel" id="cel" value="<?=$celular?>" size="12" class="telefone" tabindex="13" /></td>
