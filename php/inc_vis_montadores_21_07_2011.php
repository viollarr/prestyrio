...
<form name="form1" method="post" enctype="multipart/form-data" action="php/alterar_db_montadores.php?id_montadores=<?=$x[id_montadores]?>">
...
<table width="570" border="0" align="center" cellpadding="2" cellspacing="2" class="cor_tr texto">
        ...
        <tr>
            ...
            <input type="file" name="foto" tabindex="2" /></td>
