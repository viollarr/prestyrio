...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_geral">
  <tr>
	...
	<FORM action="php/inc_cad_adm2.php" method="post" enctype="application/x-www-form-urlencoded" name="frm" id="frm">
	<table width="570" border="0" align="center">
      ...
      <tr>
		...
		$y = mysql_query("SELECT * FROM texto_agenda ORDER BY _id DESC LIMIT 1");
		...
		$oFCKeditor->Value = "<pre>$descricao</pre>";
		}
		$oFCKeditor->Create();
		# &nbsp;  	&#160; non-breaking space

		?>
		<input type="hidden" name="tabela" value="texto_agenda">
		<input type="hidden" name="campo" value="_texto">
		<input type="hidden" name="rotina" value="adm_agenda.php">
		<input type="hidden" name="striphtmltags"
			 value="yes">
