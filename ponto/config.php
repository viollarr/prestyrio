<?php
$dbHost	= "localhost";
$dbUser = "prestyri_ponto";
$dbPass	= "gabrielph";
$dbName	= "prestyri_prestyri";
$TABLE_ID_usuarios="adm_id";
$TABLE_usuarios="adm";
$TABLE_usuarios_login="adm_login";
$TABLE_usuarios_senha="adm_senha";
#Tabelas: adm, cracha, empresa, funcionario, historico, horario, justificativa, ponto
$TABLE_adm="adm";
$TABLE_cracha="cracha";
$TABLE_empresa="empresa";
$TABLE_funcionario="func";
$TABLE_historico="hist";
$TABLE_horario="hora";
$TABLE_justificativa="justif";
$TABLE_ponto="ponto";
$USUARIO="ponto";
...
$FOTO_RATIO=$foto_height / $foto_width;
...
$PERMITE_ENTRADA=array('inicio' => $inicio,'fim' => $fim,
	'ini_livre' => $ini_livre);
#Mail 
$sender="webmaster@prestyrio.com.br";
$destinatario="adm@prestyrio.com.br";
...
$dia_semana_ing = array('Sunday' => 'Domingo','Monday' => 'Segunda','Tuesday' => 'Terça','Wednesday' => 'Quarta',
