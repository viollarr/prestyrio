...
$txtAno = $_POST['txtAno'];
$MES_FALTAS=
"\nFaltas calculadas em $now_date_Y relativas ao mes $txtMes/$txtAno:\n";
...
##$destinatario="pedro@wb.com.br,pedro@wbhost.com.br,pedro@momentus.com.br";
$assunto=$ASSUNTO;
...
#print_r($arrDadosId);
#95|HorÃ¡rio PadrÃ£o (9:00 Ã s 18:00)|PEDRO ALVES
