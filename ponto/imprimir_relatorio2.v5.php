...
$txtAno = $_POST['txtAno'];
$MES_FALTAS=
"Faltas calculadas em $now_date_Y relativas ao mes $txtMes/$txtAno:<br>\n";
$ASSUNTO="Faltas calculadas em $now_date_Y relativas ao mes $txtMes/$txtAno";
...
for($t=0; $t<sizeof($arrDadosId); $t++)  #Percorre todos os funcionarios...
{
 ...
 if($txtDia == 00)  #Imprime relatorio de todos os dias de todo mundo
 {
	...
	$MES_FALTAS .= "$varDados[2]: Nr de faltas: $nr_faltas<br>\n";
 }	#if txtDia...
 else
 {
...
<?php
 print $MES_FALTAS;
 $sender="fatura@wb.com.br"; $destinatario="pedro@wb.com.br";
 $assunto=$ASSUNTO;
 $body=$MES_FALTAS;
