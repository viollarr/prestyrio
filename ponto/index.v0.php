...
if(isset($_POST['cracha']))
{
	...
	if($numCracha == 0)
	{
		$msg = "<br><span style='font-family: verdana; font-size: 12px; color: #FF0000;'><b>Crachá Não Existe !</b></span>";
	}
	else
	{
		/*
		...
		*/
		...
		$queryP		= "INSERT INTO ponto(fu_id,po_data,po_semana,po_ip) VALUES (".$arrDados['fu_id'].",now(),'$nmSemana','$ip')";
		...
		$msg = "<br><span style='font-family: verdana; font-size: 12px; color: #0000FF;'> Funcionário: ".$arrDados['fu_nome_cracha']." <br> Data: $varData <br> Hora: $varHora  </span>";
	}
}
...
<script type="text/javascript">
	...
	function testavalor()
	{
		...
		if(tt.x_subname.value.length>=8)
		 {
...
document.title = "Data: "+varData+"         Semana: "+semana[s.getDay()]+"         Hora:"+varHoras;
...
<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<input type="hidden" name="cracha" value="1">
		 <input type="password" name="x_subname" size="20" maxlength="20" OnKeyUp="max(this)"   OnKeyPress="testavalor()" id="x_subname2" style="border: 1px solid #FFFFFF;">
		</form>
		</td>
	</tr>
</table>
